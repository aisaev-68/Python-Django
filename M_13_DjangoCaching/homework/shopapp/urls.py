...
urlpatterns = [
    ...
    path("catalog/<str:eng_name>/archived/", CatalogProducts.as_view(), name="catalog_products"),
    path("products_by_category/<str:tag>/", ShowProductsPage.as_view(), name="products_by_category"),
